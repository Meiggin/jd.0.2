...
-- 数据库: `tianmao`
--
CREATE DATABASE `tianmao` DEFAULT CHARACTER SET gbk COLLATE gbk_chinese_ci;
USE `tianmao`;
...
INSERT INTO `activity` (`id`, `imgUrl`) VALUES
(1, 'https://img.alicdn.com/imgextra/i4/2102356460/TB2GGTkhGagSKJjy0FaXXb0dpXa_!!2102356460.png_220x10000q100.jpg'),
(2, 'https://img.alicdn.com/imgextra/i2/700459267/TB2G1RPpC3PL1JjSZFxXXcBBVXa_!!700459267.jpg_220x10000q100.jpg'),
(3, 'https://img.alicdn.com/imgextra/i3/628189716/TB2ymxNegAq0eJjSZFtXXc.qVXa_!!628189716.jpg_220x10000q100.jpg'),
(4, 'https://img.alicdn.com/tfs/TB1cnHQhMoQMeJjy1XaXXcSsFXa-476-260.jpg_220x10000q100.jpg'),
(5, 'https://img.alicdn.com/imgextra/i3/1910146537/TB2OyAlbLNNTKJjSspfXXbXIFXa_!!1910146537.jpg_220x10000q100.jpg');
...
(1, 'https://img.alicdn.com/imgextra/i3/120/TB2L4w3dUEIL1JjSZFFXXc5kVXa_!!120-0-luban.jpg_q100.jpg'),
(2, 'https://img.alicdn.com/simba/img/TB1E.noPVXXXXX2XVXXSutbFXXX.jpg'),
(3, 'https://img.alicdn.com/tps/i4/TB10pFyhfBNTKJjSszbSuuFrFXa.jpg'),
(4, 'https://img.alicdn.com/simba/img/TB1o5KaSpXXXXctapXXSutbFXXX.jpg'),
(5, 'https://img.alicdn.com/imgextra/TB25J6.eUcKL1JjSZFzXXcfJXXa_!!166-0-luban.jpg_q100.jpg'),
(6, 'http://img.alicdn.com/imgextra/TB2rUtma2NNTKJjSspeXXaSwpXa_!!2-0-luban.jpg_q100.jpg');
...
INSERT INTO `brand` (`id`, `imgUrl`) VALUES
(1, 'https://img.alicdn.com/tfs/TB1ZgxLlgoQMeJjy1XaXXcSsFXa-468-644.jpg_284x284q100.jpg'),
(2, 'https://img.alicdn.com/imgextra/i2/2924318589/TB2FnLhgjlxYKJjSZFuXXaYlVXa_!!2924318589.jpg_440x440q100.jpg'),
(3, 'https://img.alicdn.com/tps/i4/TB1yVZ7bhuaVKJjSZFjSuwjmpXa.jpg_440x440q100.jpg');
...
CREATE TABLE IF NOT EXISTS `cainixihuan` (
  ...
  `imgUrl` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=gbk AUTO_INCREMENT=101 ;
...
CREATE TABLE IF NOT EXISTS `ceshi` (
  ...
  `mobile` char(11) CHARACTER SET gbk COLLATE gbk_bin NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `ceshi` (`id`, `username`, `password`, `mobile`) VALUES
(16, '江超', '25f9e794323b453885f5181f1b624d0b', '13899990000'),
(17, '江超急啊', '25f9e794323b453885f5181f1b624d0b', '13813131313');
...
CREATE TABLE IF NOT EXISTS `hideimg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `imgUrl` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `hideimg` (`id`, `imgUrl`) VALUES
(1, 'https://img.alicdn.com/bao/uploaded/TB1Nza1LFXXXXbDXFXXSutbFXXX.jpg_170x120q30.jpg'),
(2, 'https://img.alicdn.com/bao/uploaded/TB1tBlBMXXXXXXaXFXXSutbFXXX.jpg_170x120q30.jpg'),
(3, 'https://img.alicdn.com/tps/i4/TB1hp9WPpXXXXbZXFXXSutbFXXX.jpg_170x120q30.jpg'),
(4, 'https://img.alicdn.com/bao/uploaded/TB1krn7LFXXXXbVXFXXSutbFXXX.jpg_170x120q30.jpg'),
(5, 'https://img.alicdn.com/bao/uploaded/TB1Im6ULFXXXXapaXXXSutbFXXX.jpg_170x120q30.jpg'),
(6, 'https://img.alicdn.com/bao/uploaded/TB16BD9LFXXXXXhXFXXSutbFXXX.jpg_170x120q30.jpg'),
(7, 'https://img.alicdn.com/tps/i4/TB1gAvVLVXXXXbeXFXXPqXt1pXX-1000-500.png_170x120q30.jpg'),
(8, 'https://img.alicdn.com/tps/i3/TB1LX3bLVXXXXcLXXXXXpJt1pXX-1000-500.jpg_170x120q30.jpg'),
(9, 'https://img.alicdn.com/bao/uploaded/TB1TPLrIFXXXXc9XVXXSutbFXXX.jpg_170x120q30.jpg'),
(10, 'https://img.alicdn.com/bao/uploaded/TB1406DJVXXXXbHXFXXSutbFXXX.jpg_170x120q30.jpg'),
(11, 'https://img.alicdn.com/bao/uploaded/TB130ZhHpXXXXcrXVXXSutbFXXX.jpg_170x120q30.jpg'),
(12, 'https://img.alicdn.com/bao/uploaded/TB1heeRJFXXXXbCXVXXSutbFXXX.jpg_170x120q30.jpg'),
(13, 'https://img.alicdn.com/bao/uploaded/TB1Pt_VHpXXXXbzXXXXSutbFXXX.jpg_170x120q30.jpg'),
(14, 'https://img.alicdn.com/bao/uploaded/TB1OBJZJpXXXXcGXpXXSutbFXXX.jpg_170x120q30.jpg');
...
CREATE TABLE IF NOT EXISTS `jingright` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(200) NOT NULL,
  `imgUrl` varchar(200) NOT NULL,
...
INSERT INTO `jingright` (`id`, `title`, `imgUrl`, `price`) VALUES
(1, '高漫GM185数位屏手绘屏手写屏绘画屏绘图屏电脑手绘板液晶数位板', '//img-tmdetail.alicdn.com/bao/uploaded///img.alicdn.com/bao/uploaded/TB1Y33gNVXXXXc8XpXXXXXXXXXX_!!0-item_pic.jpg_160x160q90.jpg', '￥1280.00'),
(2, '高漫GM220HD数位屏手绘屏绘图屏绘画手写屏液晶电脑手绘板数位板', '//img-tmdetail.alicdn.com/bao/uploaded///img.alicdn.com/bao/uploaded/TB1q2cikO0TMKJjSZFNXXa_1FXa_!!0-item_pic.jpg_160x160q90.jpg', '￥880.00'),
(3, '绘王W58无线数位板手绘板电子绘图板写字输入板手写板电脑绘画板', '//img-tmdetail.alicdn.com/bao/uploaded///img.alicdn.com/bao/uploaded/TB1_9xeOFXXXXcwXpXXXXXXXXXX_!!0-item_pic.jpg_160x160q90.jpg', '￥3000.00'),
(4, '高漫A4 A3拷贝台LED临摹台透光板动漫透光箱书法素描发光透写台', '//img-tmdetail.alicdn.com/bao/uploaded///img.alicdn.com/bao/uploaded/TB1LfUMbS7PL1JjSZFHXXcciXXa_!!0-item_pic.jpg_160x160q90.jpg', '￥446.00'),
(5, '绘王H420数位板 手写板签名板动漫绘图板绘画板电脑手绘板画图板', '//img-tmdetail.alicdn.com/bao/uploaded///img.alicdn.com/bao/uploaded/T1ELl.FwJfXXXXXXXX_!!0-item_pic.jpg_160x160q90.jpg', '￥159.00'),
(6, '包邮送底座!绘王A3平板触控LED拷贝台透写台透光台箱看片台临摹台', '//img-tmdetail.alicdn.com/bao/uploaded///img.alicdn.com/bao/uploaded/TB1Uc1nKXXXXXXqXXXXXXXXXXXX_!!0-item_pic.jpg_160x160q90.jpg', '￥198.00');
...
CREATE TABLE IF NOT EXISTS `leftbig` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `imgUrl` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `leftbig` (`id`, `imgUrl`) VALUES
(1, 'https://img.alicdn.com/imgextra/i4/2102356460/TB2q.YjhPihSKJjy0FfXXbGzFXa_!!2102356460.jpg'),
(2, 'https://img.alicdn.com/tfs/TB1fQ1VeMoQMeJjy0FpXXcTxpXa-235-301.png'),
(3, 'https://img.alicdn.com/tfs/TB1xvaReMoQMeJjy1XaXXcSsFXa-235-301.png'),
(4, 'https://gw.alicdn.com/tfs/TB1AobKe3oQMeJjy0FoXXcShVXa-468-1236.jpg'),
(5, 'https://img.alicdn.com/tfs/TB1sJWthzihSKJjy0FfXXbGzFXa-468-1236.jpg'),
(6, 'https://img.alicdn.com/tps/i4/TB1Rd26mGmWQ1JjSZPhSutCJFXa.jpg'),
(7, 'https://img.alicdn.com/tfs/TB171IllgoQMeJjy0FnXXb8gFXa-468-1236.jpg'),
(8, 'https://img.alicdn.com/tfs/TB1vZCgl3oQMeJjy0FpXXcTxpXa-468-1236.png');
